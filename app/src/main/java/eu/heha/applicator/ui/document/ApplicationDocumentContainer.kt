...
@Composable
private fun Header(name: String, imageUrl: String, subtitle: String, contactInfo: List<String>) {
    Row(
        ...
        Surface(modifier = Modifier.padding(16.dp), shape = CircleShape) {
...
fun defaultContainerModel() = ApplicationContainerModel(
    name = "Max Mustermann",
    imageUrl = "https://avatars.githubusercontent.com/u/4068950",
